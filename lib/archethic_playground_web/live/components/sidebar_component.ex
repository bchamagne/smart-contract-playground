defmodule ArchethicPlaygroundWeb.SidebarComponent do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <aside
      ...
      >
    <div class="pt-3 pb-4 text-gray-500 dark:text-gray-400">
    <!-- Archethic logo -->
    <ul class="mt-2">
    ...
    <ul class="mt-6">
      ...
      <li class="relative px-6 py-3">
        <a
                ...
                href="#"
                data-tippy-content="File Explorer"
              >
      ...
      <li class="relative px-6 py-3">
        <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="#"
                data-tippy-content="Search Files"
              >
      ...
      <!-- end menu.search -->
      <!-- menu.validate -->
      <li class="relative px-6 py-3" x-data="{id: 1}">
        <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="#"
